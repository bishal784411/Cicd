...
#         process_count = sum(1 for p in launcher.processes.values() if p.poll() is None)
...
#             },
#             "agents_running": process_count,
#             "agent_statuses": launcher.get_status(),
#             "api_endpoints_count": len(api_router.routes)
#         }
#     except Exception as e:
